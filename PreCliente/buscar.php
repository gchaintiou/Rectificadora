...
<div align="center" class="titulo1"><?php if($nro) echo "PRESUPUESTO SELECCIONADO:";?></div>
	<?php
	if(!$buscado && !$nro)
		PantallaBusqueda(CLI);
	else if($buscado && !$nro)
		MostrarBusqueda($user_gr->GetConex(), CLI);
	else if($nro)
		$user_gr->MostrarPresOT(CLI, $nro, NO_EDIT, $cargado);
	?>
       <!-- InstanceEndEditable -->
    </td>
  </tr>
