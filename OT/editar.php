...
<table width="98%" align="center">
  ...
  <tr>
    <td width="0%" class="celda_menu_ot"><span><a href="http://www.dhtml-menu-builder.com"  style="display:none;visibility:hidden;">Javascript DHTML Drop Down Menu Powered by dhtml-menu-builder.com</a>
...
stm_bpx("p3","p1",[]);
stm_aix("p3i0","p1i0",[0,"  Global","","",-1,-1,0,"Mob/lista.php"],65,22);
stm_aix("p3i1","p3i0",[0,"  Por Item"],65,22);
stm_ep();
stm_aix("p0i15","p0i0",[]);
...
//-->
    ...
    <td width="100%" rowspan="2" valign="top" class="celda_cuerpo_ot"><!-- InstanceBeginEditable name="Trabajo" -->
	 	<?php
      $user_gr->MostrarPresOT(OT, $nro, EDIT, $cargado);
		?>
